...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, WILD_GREEN_BEAN_BUSH_KEY, Feature.SIMPLE_BLOCK,
                new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.WILD_GREEN_BEAN_BUSH.get().defaultBlockState()
                        .setValue(net.dawson.adorablehamsterpets.block.custom.WildGreenBeanBushBlock.SEEDED, true))));
        // --- End Register Green Bean ---

        // --- Register Cucumber Bush Patch ---
        register(context, WILD_CUCUMBER_BUSH_KEY, Feature.SIMPLE_BLOCK,
                new SimpleBlockConfiguration(BlockStateProvider.simple(ModBlocks.WILD_CUCUMBER_BUSH.get().defaultBlockState()
                        .setValue(net.dawson.adorablehamsterpets.block.custom.WildCucumberBushBlock.SEEDED, true))));
