...
public class AdorableHamsterPetsClient {
    ...
    public static void init() {
        ...
        ResourceManagerHelper.get(PackType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            ...
            public Identifier getFabricId() {
                return Identifier.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "hamster_texture_cache");
            }
        ...
        // --- Events ---
        ClientTickEvents.END_CLIENT_TICK.register(AdorableHamsterPetsClient::onEndClientTick);
        ...
        UseEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            ...
            if (world.isClientSide() && hand == InteractionHand.MAIN_HAND && entity instanceof HamsterEntity hamster) {
    ...
    public static void initScreenHandlers() {
        MenuScreens.register(ModScreenHandlers.HAMSTER_INVENTORY_SCREEN_HANDLER.get(), HamsterInventoryScreen::new);
    }
     ...
     * often imposed by ServerPlayer#playSound, allowing "distant" impact sounds to be heard.
     *
