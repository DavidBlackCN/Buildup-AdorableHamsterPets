...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockStateModelGenerator) {
        ...
        Identifier greenBeanSeededModelId = ModelTemplates.CROSS.createWithSuffix(
                ...
                TextureMapping.cross(new Material(wildGreenBeanSeededTexture)), blockStateModelGenerator.modelOutput
        );
        Identifier greenBeanSeedlessModelId = ModelTemplates.CROSS.createWithSuffix(
                ModBlocks.WILD_GREEN_BEAN_BUSH.get(), "_seedless",
                TextureMapping.cross(new Material(wildGreenBeanSeedlessTexture)), blockStateModelGenerator.modelOutput
        );
        Identifier cucumberSeededModelId = ModelTemplates.CROSS.createWithSuffix(
                ModBlocks.WILD_CUCUMBER_BUSH.get(), "_seeded",
                TextureMapping.cross(new Material(wildCucumberSeededTexture)), blockStateModelGenerator.modelOutput
        );
        Identifier cucumberSeedlessModelId = ModelTemplates.CROSS.createWithSuffix(
                ModBlocks.WILD_CUCUMBER_BUSH.get(), "_seedless",
                TextureMapping.cross(new Material(wildCucumberSeedlessTexture)), blockStateModelGenerator.modelOutput
        );

        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.dispatch(ModBlocks.WILD_GREEN_BEAN_BUSH.get())
                .with(BlockModelGenerators.createBooleanModelDispatch(
                        WildGreenBeanBushBlock.SEEDED,
                        BlockModelGenerators.plainVariant(greenBeanSeededModelId),
                        BlockModelGenerators.plainVariant(greenBeanSeedlessModelId)
                ))
        );

        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.dispatch(ModBlocks.WILD_CUCUMBER_BUSH.get())
                .with(BlockModelGenerators.createBooleanModelDispatch(
                        WildCucumberBushBlock.SEEDED,
                        BlockModelGenerators.plainVariant(cucumberSeededModelId),
                        BlockModelGenerators.plainVariant(cucumberSeedlessModelId)
                ))
        );
        ...
        blockStateModelGenerator.blockStateOutput.accept(
                BlockModelGenerators.createSimpleBlock(
                        ...
                        BlockModelGenerators.plainVariant(Identifier.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "block/acorn_crate"))
                )
        );
        blockStateModelGenerator.blockStateOutput.accept(
                BlockModelGenerators.createSimpleBlock(
                        ModBlocks.CUCUMBER_CRATE.get(),
                        BlockModelGenerators.plainVariant(Identifier.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "block/cucumber_crate"))
                )
        );
        blockStateModelGenerator.blockStateOutput.accept(
                BlockModelGenerators.createSimpleBlock(
                        ModBlocks.GREEN_BEANS_CRATE.get(),
                        BlockModelGenerators.plainVariant(Identifier.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "block/green_beans_crate"))
                )
        );
        blockStateModelGenerator.blockStateOutput.accept(
                BlockModelGenerators.createSimpleBlock(
                        ModBlocks.HAMSTER_FOOD_MIX_CRATE.get(),
                        BlockModelGenerators.plainVariant(Identifier.fromNamespaceAndPath(AdorableHamsterPets.MOD_ID, "block/hamster_food_mix_crate"))
                )
        );
    }
    ...
    private void generateHamsterBedVariantModels(BlockModelGenerators generator) {
        ...
        for (String wood : woodTypes) {
            ...
            TextureMapping textureMap = new TextureMapping().put(TextureSlot.PARTICLE, new Material(particleTexture));
