...
public class ModBlocks {
    ...
    private static BlockBehaviour.Properties blockProperties(BlockBehaviour.Properties properties) {
        return properties.setId(DeferredRegister.activeKey(BuiltInRegistries.BLOCK));
    }

    // --- 1. Create a DeferredRegister for Blocks ---
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(AdorableHamsterPets.MOD_ID, BuiltInRegistries.BLOCK);
    ...
    public static final RegistrySupplier<Block> GREEN_BEANS_CROP = registerBlock("green_beans_crop",
              () -> new GreenBeansCropBlock(blockProperties(cropProperties())));

    public static final RegistrySupplier<Block> CUCUMBER_CROP = registerBlock("cucumber_crop",
              () -> new CucumberCropBlock(blockProperties(cropProperties())));

    public static final RegistrySupplier<Block> WILD_GREEN_BEAN_BUSH = registerBlock("wild_green_bean_bush",
            () -> new WildGreenBeanBushBlock(blockProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.SWEET_BERRY_BUSH)
                    .noOcclusion()
                      .noCollision()
                    .randomTicks()
    ...
    public static final RegistrySupplier<Block> WILD_CUCUMBER_BUSH = registerBlock("wild_cucumber_bush",
            () -> new WildCucumberBushBlock(blockProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.SWEET_BERRY_BUSH)
                    .noOcclusion()
                      .noCollision()
                    .randomTicks()
                    .sound(SoundType.SWEET_BERRY_BUSH))));
    ...
    public static final RegistrySupplier<Block> SUNFLOWER_BLOCK = registerBlock("sunflower_block",
            () -> new SunflowerBlock(blockProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.SUNFLOWER)
                    .noOcclusion()
    ...
    public static final RegistrySupplier<Block> HAMSTER_BED = registerBlock("hamster_bed",
            () -> new HamsterBedBlock(blockProperties(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(0.5F).sound(SoundType.WOOD).noOcclusion())));

    // --- Crates ---
    public static final RegistrySupplier<Block> ACORN_CRATE = registerBlock("acorn_crate",
            () -> new Block(blockProperties(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).sound(SoundType.WOOD).strength(2.0F, 3.0F))));
