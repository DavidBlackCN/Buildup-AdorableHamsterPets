...
public class ModClientCommands {
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher, CommandBuildContext registryAccess) {
        dispatcher.register(ClientCommands.literal("ahp_print_currently_rendered_hamster_textures_to_disc")
                .executes(context -> {
        ...
        dispatcher.register(ClientCommands.literal("ahp_open_config_screen")
                .executes(context -> {
        ...
        dispatcher.register(ClientCommands.literal("ahp_disable_throw_warning")
                .executes(context -> {
