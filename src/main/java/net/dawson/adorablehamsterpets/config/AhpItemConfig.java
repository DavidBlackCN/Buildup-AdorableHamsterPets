...
public class AhpItemConfig extends Config {
    ...
    public List<String> pouchAllowedItems = new ArrayList<>(List.of(
            "minecraft:torch", "minecraft:soul_torch", "minecraft:redstone_torch", "minecraft:repeater", "minecraft:comparator", "minecraft:lever", "#minecraft:buttons", "#minecraft:pressure_plates", "minecraft:wheat_seeds", "minecraft:beetroot_seeds", "minecraft:pumpkin_seeds", "minecraft:melon_seeds", "minecraft:pitcher_pod", "minecraft:torchflower_seeds", "#c:seeds"
    ));
    ...
    @Translatable.Desc("The list of dropped items a hamster may hunt down and stuff in its cheeks. Accepts item IDs (e.g. 'minecraft:wheat') or tags (e.g. '#adorablehamsterpets:seeds'). This custom union tag includes Fabric convention tags such as 'c:seeds'.")
    ...
    @Translatable.Desc("The list of crop blocks a hamster may decide to harvest and replant. Accepts specific block IDs (e.g. 'minecraft:wheat') or tags (e.g. '#adorablehamsterpets:crops'). This custom union tag includes Fabric convention tags such as 'c:crops'.")
