...
public class HamsterPlayWithItemGoal extends HamsterAbstractItemInteractionGoal {
    ...
    public boolean canUse() {
        ...
        if (this.hamster.isHoldingMouthItem()) {
            if (this.hamster.isOrderedToSit() || this.hamster.isFrozenMovement() || !(this.hamster.getOwner() instanceof Player)) {
                return false;
            }
    ...
    protected boolean canStartBaseChecks() {
        ...
        if (this.hamster.isHoldingMouthItem() || this.hamster.isOrderedToSit()) {
            return false;
        }
    ...
    protected boolean shouldContinueBaseChecks() {
        if (this.hamster.isOrderedToSit() || this.hamster.isFrozenMovement() || this.owner == null || !this.owner.isAlive()) {
            return false;
        }
